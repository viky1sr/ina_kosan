...
{{--                    @endif--}}
        ...
        <ul class="nav pcoded-inner-navbar ">
            ...
            @role('admin')
            <li class="nav-item">
                <a href="{{route('vendor.list')}}" class="nav-link"><span class="pcoded-micon"><i class="feather icon-user-check"></i></span><span class="pcoded-mtext">List Register Vendor</span></a>
            </li>
            @endrole
...
{{--            </li>--}}
            <li class="nav-item pcoded-hasmenu">
                ...
                <ul class="pcoded-submenu" >
                    <li><a href="{{route('visitor.index')}}">Vendor</a></li>
...
{{--                </li>--}}
                ...
                <li class="nav-item">
                    <a href="{{route('my-kosan.index')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-shopping-cart"></i></span><span class="pcoded-mtext">
                            @if(Auth::user()->hasRole('member'))
                                My Kosan
                            @else
                                List Penyewaan Kosan
                            @endif
